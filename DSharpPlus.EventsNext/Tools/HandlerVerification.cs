...
using DSharpPlus.EventsNext.Entities.Exceptions;
...
internal static class HandlerVerification
{
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    [DoesNotReturn]
    private static void ThrowNoHandlerInterfaces(string paramName, Type interfaceType, string message) => throw new NotEventHandlerCanidateException(message, paramName, interfaceType);
}