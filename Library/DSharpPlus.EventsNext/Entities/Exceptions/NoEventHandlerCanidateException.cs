...
public class NoEventHandlerCanidateException : ArgumentException
{
    ...
    public NoEventHandlerCanidateException(string? paramName, Type invalidHandlerInterface) : this($"The type {invalidHandlerInterface.Name} was did not implement/was not assignable to any {nameof(DSharpPlus.EventsNext)} interfaces", paramName, invalidHandlerInterface) { }
