...
public class NoEventHandlerCandidateException : ArgumentException
{
    /// <summary>
    ...
    /// <summary>
    /// Constructs a new instance of the <see cref="NoEventHandlerCandidateException"/>
    /// </summary>
    ...
    public NoEventHandlerCandidateException(string? paramName, Type invalidHandlerInterface) : this($"The type {invalidHandlerInterface.Name} was did not implement/was not assignable to any {nameof(EventsNext)} interfaces", paramName, invalidHandlerInterface) { }
    ...
    public NoEventHandlerCandidateException(string? message, string? paramName, Type invalidHandlerType) : base(message, paramName) => InvalidHandlerType = invalidHandlerType;
    ...
    /// <param name="paramName">The argument which caused this exception</param>
    /// <param name="invalidHandlerType">The type which was not a valid handler</param>
    public NoEventHandlerCandidateException(string? message, string? paramName, Type invalidHandlerType, Exception? innerException) : base(message, paramName, innerException) => InvalidHandlerType = invalidHandlerType;
}
